...
deletion, and Conversations are lifecycle APIs and are not completion
operations in this CLI. WebSocket mode is a transport for the same completion,
and rides the adapter seam described below.
